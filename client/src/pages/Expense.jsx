...
const expenses = result.filter((item) => item.type === "Expense");
  ...
  return (
    ...
    <div className='h-[calc(100vh-66px)] md:h-screen overflow-y-auto overflow-x-hidden  '>
      <div className='p-3 w-full flex justify-between items-center'>
           <h1 className='text-2xl md:text-3xl lg:text-4xl font-bold '>Expenses</h1>
           <div className='mx-3 my-2 font-bold text-lg'>
             <h1 className='text-lg '>All Time Total : -{totalExp}/-</h1>
           </div>
         </div>
      ...
      <div>
        ...
        .filter((item,id)=>item.type==="Expense").map((item,id)=>(
